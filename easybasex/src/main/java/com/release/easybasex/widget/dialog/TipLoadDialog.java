package com.release.easybasex.widget.dialog;
...
public class TipLoadDialog {
    ...
    public TipLoadDialog(Context context, String info, int type) {
        ...
        view = LayoutInflater.from(context).inflate(R.layout.cyc_tip_dialog_view, null);
        ...
        if (type != ICON_TYPE_LOADING) {
            img.post(new Runnable() {
                ...
                public void run() {
                     ...
                     * 88太小  设置为200
                     */
                    int maxWidth = DensityUtil.dpToPxInt(200);
